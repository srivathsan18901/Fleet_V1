...
export class ProjectService {
  ...
  private inLive: BehaviorSubject<boolean> = new BehaviorSubject<boolean>(
    false
  );
  private isFleetUp: BehaviorSubject<boolean> = new BehaviorSubject<boolean>(
    false
  );
  ...
  setInitializeMapSelected(value: boolean) {
    ...
    this.cookieService.set(
      'mapInitializeStatus',
      this.initializeMapSelectedStatus
    );
  }
